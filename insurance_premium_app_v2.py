...
MAKE = st.selectbox("Make", ["NISSAN", "TOYOTA",
                             ...
                             "ZX-TOP", "LAND CRUISER", "SUGERCANE TRAILER", "GLEEY", "MERCHEDES", "COMBI", "CORE DRILLING RING", "WATER PUMP", "JIN BEI", "SOCOOL", "RANGEROVER", "JAC", "LISBO", "DIAHATSU", "SINO", "BELL TRACTOR", "ZONGSHEN", "CADILLAC", "TOYOTA*", "CLASS", "GMC", "CALDINESS FORK LIFTS", "DAHATSUN", "DAIHATSU TERIOS", "RENAULT*", "MITSUBISHI*", "NISSAN*", "T0Y0TA", "SKY BUS", "KAMAZ", "KAMZ", "GRADER", "EXCAVATOR", "LOADER", "DOZER", "LAND ROVER", "TRAKER", "MINI BUS", "LEXUS", "MAHANDRA", "PLATENA", "CATERPILLAR", "BRIDGE", "REXTON", "AWASH", "ROLLER", "VOLKSWAGEN", "CHANA", "1982", "AUTO", "WINEGEL", "P/UP", "BEBEN SEMI TRAILER", "JOHN DEER", "JOHNDEER", "BELL", "GEELY", "AMBULANCE", "FOTTON", "RENAULT/STOLARCZYK", "TRACTOR TRAILER", "330-30 TRAILER", "MAN", "MASSY FUREGUSON", "SAMI", "CITROEN", "RED FOX", "CAT DOZER", "ZEPPLIN", "VIBRATION ROLLER", "ZOTYE", "CATERPILLAR TRACTOR", "TRACTOR", "CASE", "VERCYA", "KAT", "FORCE", "TICO", "JIEFANG", "LANDINI", "TALER", "ZMAY", "DANDO GEATECH 7.5 HYDOLIC TOP ROTATYING", "GREAT WALL", "VERSATILE", "POWER PLUS DOSER", "POWER PLUS DOZER", "NIO", "HOVER", "WUCING", "ISUZU FVR", "CHANGHE", "USA", "FORLAND", "DIHATSU", "EMGTAND", "CAT", "GORICA", "AFRO", "PAGOT", "PONTIAC", "TOYOTA LAND CRUISER", "1985", "MATIZ", "SUZUKI GRAND VITARA", "DANGIFAN", "ALFA", "MOTOR CYCLE", "LONGJIANG", "LOW BED", "VISTO", "VOLS WAGEN", "IFA", "DAYUN", "TERIOS", "DISCOVERY2.5", "TEKEZE", "CAMZ", "2011", "ZUNGSHUN", "WAZ"])
